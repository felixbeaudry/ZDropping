...
load('indivlistgenoA.rdata')
old_colnames <- colnames(indivlistgeno)
colnames(indivlistgeno) <- c("USFWS", "Year", "category", "genotyped", "Dad", "Mom", "Sex", old_colnames[8:10730])
...
datafreq1990<-laply(names(indivlistgeno)[8:10730],function(x) 
...
#save
save(simdataTrue,file='simdataTrueA.rdata')
...
save(sim,file=paste("SimAlleleFreqAYr_",year,".rdata",sep=''))
...
#save output
save(simVar,file=paste("simVarA_",today,".rdata",sep=''))
